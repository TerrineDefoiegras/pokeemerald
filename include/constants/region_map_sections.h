...
#define MAPSEC_BERRY_GARDEN                 0xD5
#define MAPSEC_MORNINGSUN_BEACH             0xD6
#define MAPSEC_SCORCHING_VALLEY             0xD7
#define MAPSEC_SANDTOMB_CAVE                0xD8
#define MAPSEC_COTTON_SHORE                 0xD9
#define MAPSEC_ROUTE_119_BIS                0xDA
#define MAPSEC_ROUTE_120_BIS                0xDB
#define MAPSEC_ROUTE_135                    0xDC
#define MAPSEC_ROUTE_136                    0xDD
#define MAPSEC_ROUTE_137                    0xDE
#define MAPSEC_ROUTE_138                    0xDF
#define MAPSEC_ROUTE_139                    0xE0
#define MAPSEC_ROUTE_140                    0xE1
#define MAPSEC_ROUTE_141                    0xE2
#define MAPSEC_ROUTE_142                    0xE3
#define MAPSEC_ROUTE_143                    0xE4
#define MAPSEC_ROUTE_144                    0xE5
#define MAPSEC_ROUTE_145                    0xE6
#define MAPSEC_ROUTE_146                    0xE7
#define MAPSEC_ROUTE_147                    0xE8
#define MAPSEC_ROUTE_148                    0xE9
#define MAPSEC_ROUTE_149                    0xEA
#define MAPSEC_ROUTE_150                    0xEB
#define MAPSEC_ROUTE_151                    0xEC
#define MAPSEC_ROUTE_152                    0xED
#define MAPSEC_ROUTE_153                    0xEE
#define MAPSEC_ROUTE_154                    0xEF
#define MAPSEC_ROUTE_155                    0xF0
#define MAPSEC_ROUTE_156                    0xF1
#define MAPSEC_ROUTE_157                    0xF2
#define MAPSEC_ROUTE_158                    0xF3
#define MAPSEC_ROUTE_159                    0xF4
#define MAPSEC_ROUTE_160                    0xF5
#define MAPSEC_TREETOP_SUMMIT               0xF6
#define MAPSEC_REUNICOVE_TOWN               0xF7
#define MAPSEC_REUNICOVE_FOREST             0xF8
#define MAPSEC_COTTONBERRY_TOWN             0xF9
#define MAPSEC_EVERGRAND_ISLAND             0xFA
#define MAPSEC_DEWFORD_ISLAND               0xFB
#define MAPSEC_DEWFORD_ARCHIPELAGO          0xFC
#define MAPSEC_SHINEFALL_TOWN               0xG0
#define MAPSEC_CHERRYCOVE_FOREST            0xG1
#define MAPSEC_ORVEILED_TOWN                0xG2
#define MAPSEC_PINCORAL_BAY                 0xG3
#define MAPSEC_SPRINGARBOR_TOWN             0xG4
#define MAPSEC_CHERRYBURG_TOWN              0xG5
#define MAPSEC_CHERRUNITY_CITY              0xG6
#define MAPSEC_CHERRYCOVE_SUMMIT            0xG7
#define MAPSEC_CRESCENTPEAK_TOWN            0xG8
#define MAPSEC_SPRINGARBOR_TOWN             0xG9
#define MAPSEC_NONE                         0xGA
